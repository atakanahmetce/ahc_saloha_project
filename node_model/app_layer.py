...
class SAlohaAppLayer(GenericModel):
    def __init__(self, *args, **kwargs):
        ...
        self.sent_packets = {}
        self.sent_ack = {}
        print(self.identifier, " constructed in init")
    ...
    def on_message_from_bottom(self, eventobj: Event):
        ...
        if msg_type == SAlohaAppLayerMessageTypes.DATA:
            ack_header = SAlohaAppLayerMessageHeader(
                SAlohaAppLayerMessageTypes.ACK, self.node_id, source
            )
    ...
    def send_data(self, eventobj: Event):
        ...
        data_header = SAlohaAppLayerMessageHeader(
            SAlohaAppLayerMessageTypes.DATA, source, destination
        )
